...
public class CustomTitleBar {
    ...
    public static void getTitleBar_Backup(final Activity activity,String title, final RightDeal rightDeal){
        activity.requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        activity.setContentView(R.layout.layout_titlebar_backup);
        activity.getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE,R.layout.layout_titlebar_backup);
        ...
        ImageView bar_right = (ImageView) activity.findViewById(R.id.bar_right);
        bar_right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rightDeal.deal();
