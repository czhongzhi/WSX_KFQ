...
public class DateFormatHelp {
    ...
    public static final DateFormat TIME_YEAR = new SimpleDateFormat("yyyy");    //获取年份
    ...
    public static int timeDiffer(long oldtime,long newtime){
        //long temp = newtime - oldtime;
        return Integer.valueOf(DateFormatHelp.Seconds.format(new Date((newtime - oldtime))));
    }
