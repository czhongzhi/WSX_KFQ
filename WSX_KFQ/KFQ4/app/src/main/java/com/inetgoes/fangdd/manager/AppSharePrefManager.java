...
public class AppSharePrefManager {
    ...
    public String getMatePara_area() {
        return getSp().getString("getMatePara_area", "福田区");
    }
    ...
    public String getMatePara_huxing() {
        return getSp().getString("getMatePara_huxing", "不限");
    }
    ...
    public String getMatePara_price() {//保存价格
        return getSp().getString("getMatePara_price", "0~9000");
    }
    ...
    public int getMatePara_price_index() {//保存价格下标
        return getSp().getInt("getMatePara_price_index", 0);
    }

    public void setMatePara_price_index(int index) {
        getEdit().putInt("getMatePara_price_index", index).commit();
    }

    public String getMatePara_peitao() {
        return getSp().getString("getMatePara_peitao", "不限");
    }
    ...
    public void setMatePara(String area, String huxing, String price,int priceIndex, String peitao, String loupan, String reqtyoe, String city) {
        instance_.setMatePara_area(area);
        instance_.setMatePara_huxing(huxing);
        instance_.setMatePara_price(price);
        instance_.setMatePara_price_index(priceIndex);
